...
router.get("/api/exportxlsx", async (req, res) => {
    ...
    if (req.query.start_date && req.query.end_date) {
        ...
        result_res = await Data.find({ //query today up to tonight
            date_data: {
                $gte: start_date,
                $lt: end_date
            },
        ...
        result_res = await Data.find({ verify_status: true }).sort({ "date_data": -1 }) //.then((result_res) => {
    }
    ...
    if (result_res) {
        ...
        while (row <= rowCount) {
            ...
            data.push({
                ...
                license: result2[row - 1].licensepartone + "-" + result2[row - 1].licenseparttwo + "-" + result2[row - 1].licensepartthree,
            });
            row += 1;
        }
        console.log(data)
        ...
        //  Header
        ws.cell(3, 1).string("ลำดับ").style({
            alignment: {
                vertical: ['center'],
                horizontal: ['left']
            },
        ...
        ws.cell(3, 3).string("นามสกุล").style({
            alignment: {
                vertical: ['center'],
                horizontal: ['left']
            },
        ...
        ws.cell(3, 5).string("รหัสนิสิต").style({
            alignment: {
                vertical: ['center'],
                horizontal: ['left']
            },
        ...
        ws.cell(3, 6).string("วันที่บันทึกข้อมูล").style({
            alignment: {
                vertical: ['center'],
                horizontal: ['left']
            },
        ...
        ws.cell(3, 7).string("ป้ายทะเบียน").style({
            alignment: {
                vertical: ['center'],
                horizontal: ['left']
            },
        ...
        if (data.length) {
            data.forEach((item, i) => {
                ...
                ws.cell(currentRow, 1).number(i + 1).style({
                    alignment: {
                        vertical: ['center'],
                        horizontal: ['left']
                    },
                ...
                ws.cell(currentRow, 2).string(item.first_name).style({
                    alignment: {
                        vertical: ['center'],
                        horizontal: ['left']
                    },
                ...
                ws.cell(currentRow, 3).string(item.last_name).style({
                    alignment: {
                        vertical: ['center'],
                        horizontal: ['left']
                    },
                ...
                ws.cell(currentRow, 4).string(item.faculty).style({
                    alignment: {
                        vertical: ['center'],
                        horizontal: ['left']
                    },
                ...
                ws.cell(currentRow, 5).string(item.student_id).style({
                    alignment: {
                        vertical: ['center'],
                        horizontal: ['left']
                    },
                ...
                ws.cell(currentRow, 6).string(item.date_data).style({
                    alignment: {
                        vertical: ['center'],
                        horizontal: ['left']
                    },
                ...
                ws.cell(currentRow, 7).string(item.license).style({
                    alignment: {
                        vertical: ['center'],
                        horizontal: ['left']
                    },
